# -*- coding: utf-8 -*-
"""
Created on Thu Sep 13 11:05:44 2018
...
##mobile phone link
html =urlopen("https://www.gsmarena.com/motorola-phones-4.php")
bsObj =BeautifulSoup(html,"lxml")
filename="motorola2.csv"
f=open(filename,"wt")
headers= "Model,Year,Price,Storage,Display,Camera,Battery,Colours\n"
...
for phones in bsObj.findAll("div",{"class":"makers"}):
    for a in phones.findAll('a'):
     ...
     while a < len(Model):
         ...
         f.write(x1.replace(","," ") + "," + x2.replace(","," ") +"," + x3.replace(","," ") + ","+ x5.replace(","," ") +"," + x6.replace(","," ") +"," + x7.replace(","," ") +","+ x8.replace(","," ") +","+ x9 .replace(","," ")+"\n" )
         a=a+1
