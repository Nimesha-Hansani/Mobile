# -*- coding: utf-8 -*-
"""
Created on Thu Sep 13 10:45:05 2018
...
##mobile phone link
html =urlopen("https://www.gsmarena.com/blackberry-phones-36.php")
bsObj =BeautifulSoup(html,"lxml")
filename="BlackBerry_new.csv"
f=open(filename,"wt")
...
for phones in bsObj.findAll("div",{"class":"makers"}):
    for a in phones.findAll('a'):
     ...
     while a < len(Model):
         ...
         f.write(x1.replace(","," ") + "," + x2.replace(","," ") +"," + x3.replace(","," ") + ","+ x4.replace(","," ") +","+ x5.replace(","," ") +"," + x6.replace(","," ") +"," + x7.replace(","," ") +","+x9.replace(","," ") +"\n" )
         a=a+1
